...
description: Implement the clinic project's Doctor AI, Pharmacy AI, or Patient AI triage/booking product workflows and deterministic tool policies. Use for persona APIs, Inertia surfaces, context minimization, conversations/runs, guarded outputs, and explicit human actions; not for Phase 16 platform mechanics or AI evaluation approval.
---
