...
- Engineering telemetry is not the admin dashboard. Phase 20 receives a reviewed safe projection and never browser credentials, PromQL/Loki expressions, raw traces/logs, topology, or an operations control plane.
