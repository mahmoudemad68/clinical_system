...
REQUIRED_CODEOWNERS = (
    ...
    "scripts/ci/verify_core_api_grpc_openvex.py",
    "scripts/ci/verify_module_catalog_classification.py",
    "infra/security/sast-designs-exclusion.md",
    ...
    "infra/security/vex/core-api-frankenphp-cve-2026-84304.openvex.json",
    "infra/security/vex/core-api-frankenphp-cve-2026-84304.applicability.json",
    "infra/security/vex/core-api-frankenphp-cve-2026-84445.openvex.json",
    "infra/security/vex/core-api-frankenphp-cve-2026-84445.applicability.json",
    ".gitleaks.toml",
    ".semgrep.yml",
