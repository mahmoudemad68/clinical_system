    ...
    public static function plan(): array
    {
        return [
            ...
            new SubjectHoldingPlan(
                ...
                SubjectHoldingAction::IrreversibleTombstone,
                'Pending invitations targeting the subject HMAC, and pending invitations on the subject doctor\'s locations, become cancelled so they cannot later be accepted. Phone HMAC is tombstoned. Plaintext phone is never stored.',
            ),
        ];
    }
