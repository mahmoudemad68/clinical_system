...
final class AuthController
{
    ...
    public function register(Request $request, RegisterAccountService $handler): JsonResponse
    {
    ...
    public function verifyOtp(Request $request, VerifyOtpService $handler): JsonResponse
    {
        $data = ClosedJsonValidator::validate($request, [
    ...
    public function login(Request $request, AuthenticatePasswordService $handler): JsonResponse
    {
        $data = ClosedJsonValidator::validate($request, [
            'phone' => ['required', 'string', 'max:32'],
            'password' => ['required', 'string', 'max:128'],
    ...
    public function refresh(Request $request, RefreshDeviceSessionService $handler): JsonResponse
    {
        $data = ClosedJsonValidator::validate($request, [
    ...
    public function logout(Request $request, SessionCommandService $handler): JsonResponse
    {
    ...
    public function sessions(Request $request, SessionCommandService $handler): JsonResponse
    {
        return Envelope::ok($handler->list($this->actor($request)), $this->requestId($request));
    }

    public function destroySession(Request $request, SessionCommandService $handler, string $sessionId): JsonResponse
    {
    ...
    public function revokeAll(Request $request, SessionCommandService $handler): JsonResponse
    {
    ...
    public function changePassword(Request $request, SessionCommandService $handler, PasswordHasher $hasher, PasswordPolicy $policy): JsonResponse
    {
        $data = ClosedJsonValidator::validate($request, [
    ...
    public function recoveryStart(Request $request, RequestOtpService $handler): JsonResponse
    {
        $data = ClosedJsonValidator::validate($request, [
            'phone' => ['required', 'string', 'max:32'],
            'language' => ['sometimes', Rule::in(['ar', 'en'])],
    ...
    public function recoveryComplete(Request $request, CompleteRecoveryService $handler): JsonResponse
    {
        $data = ClosedJsonValidator::validate($request, [
            'challenge_id' => ['required', 'uuid'],
            'code' => ['required', 'string', 'size:6'],
    ...
    public function enrollTotp(Request $request, EnrollTotpService $handler): JsonResponse
    {
        return Envelope::ok($handler->handle($this->actor($request)), $this->requestId($request));
    }

    public function confirmTotp(Request $request, ConfirmTotpService $handler): JsonResponse
    {
        $data = ClosedJsonValidator::validate($request, [
            'code' => ['required', 'string', 'size:6'],
        ]);
    ...
    public function rotateRecoveryCodes(Request $request, RotateRecoveryCodesService $handler): JsonResponse
    {
        $data = ClosedJsonValidator::validate($request, [
            'code' => ['required', 'string', 'size:6'],
        ]);
    ...
    public function disableTotp(Request $request, DisableTotpService $handler): JsonResponse
    {
        $data = ClosedJsonValidator::validate($request, [
            'code' => ['required', 'string', 'size:6'],
        ]);
    ...
    public function applyRecovery(Request $request, ApplyRecoveryService $handler, string $id): JsonResponse
    {
