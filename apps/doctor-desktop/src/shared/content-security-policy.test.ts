...
describe('Clinic Doctor — packaged vs development CSP', () => {
  ...
  it('development CSP allows self scripts without unsafe-eval', () => {
    ...
    expect(DEVELOPMENT_CONTENT_SECURITY_POLICY).not.toContain('data: for script');
...
describe('Clinic Doctor — non-eval renderer webpack', () => {
...
describe('Clinic Doctor — local HTTP is development-only', () => {
